...
We note that the data from BindingDB is quite sparse. This is due to the curation process we used for version 1 which only analyzes the data from BindingDB that database had curated from literature. As such at present the overlap between those compounds and the content of AnnotationDB is small. As AnnotationDB is actively being expanded we anticipate this will change in the near future. 
...
fps <- assays(hdd_v1)[["fingerprint.Morgan.3.512"]]
